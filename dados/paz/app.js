const faces=[
 ...
 {image:'assets/escucho-al-otro.png',color:'#9ebc2f',rotation:'rotateX(-17deg) rotateY(90deg)',text:{es:['Escucho al otro','Regala una conversación sin interrumpir ni apresurar la respuesta.'],en:['I listen to others','Offer a conversation without interrupting or rushing the answer.'],it:["Ascolto l’altro",'Offri una conversazione senza interrompere o affrettare.'],fr:["J’écoute l’autre",'Offre une conversation sans interrompre ni presser.'],ca:["Escolto l’altre",'Ofereix una conversa sense interrompre ni apressar.']}},
 {image:'assets/soy-el-primero-en-amar.png',color:'#5595c8',rotation:'rotateX(-107deg) rotateY(0deg)',text:{es:['Soy el primero en amar','Da el primer paso sin esperar a que la otra persona lo haga.'],en:['I am the first to love','Take the first step without waiting for someone else.'],it:['Sono il primo ad amare','Fai il primo passo senza aspettare l’altra persona.'],fr:['Je suis le premier à aimer','Fais le premier pas sans attendre l’autre personne.'],ca:['Soc el primer a estimar','Fes el primer pas sense esperar l’altra persona.']}},
 {image:'assets/nos-perdonamos.png',color:'#d8b9d3',rotation:'rotateX(-17deg) rotateY(180deg)',text:{es:['Nos perdonamos','Suelta una pequeña ofensa y abre espacio para comenzar de nuevo.'],en:['We forgive one another','Let go of a small hurt and make room to begin again.'],it:['Ci perdoniamo','Lascia andare una piccola offesa e ricomincia.'],fr:['Nous nous pardonnons','Laisse partir une petite blessure et recommence.'],ca:['Ens perdonem','Deixa anar una petita ofensa i torna a començar.']}},
